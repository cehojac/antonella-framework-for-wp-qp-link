...
class Config
{
    ...
    * @example ['post_data'=>'UYGDDI::function']
    */
    public $post=[
    ];
    /**
    ...
    * @example ['get_data'=>'UYGDDI::function']
    */
    public $get=[
    ];
    /**
    ...
    * @input array
    * @example ['body_class','UYGDDI::function',10,2]
    * @example ['body_class',['UYGDDI','function'],10,2]
    */
    public $add_filter=[
    ];
    ...
    * @input array
    * @example [['example','UYGDDI\ExampleController::example_shortcode']]
    */
    public $shortcodes=[
        ['qr-code','UYGDDI\Shortcodes::qrCode']
    ];
    /**
